...
global.initLogin = function(){
	if(util.getCookie("_islogin")){
		$('#loginWrap').show();
		$('#unloginWrap').hide();
//		util.doAsyncGet("https://login.in.meizu.com/uc/webjsp/member/getNickname",function(result){
...
global.setValidate = function() {
    ...
    _addMethod("zdiyRemote", function(value, element, param) {
        ...
        // 增加国家码
        return oldRemote.call(this, '00' + parseInt($('#cycode').val()) + ':' + value, element, newParam);
...
global.setFormInput = function() {
    $('form input').focus(function() {
        ...
        if(this.id === 'phone') $temp = $('#cycode-box')
