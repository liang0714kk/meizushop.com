    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" action="{{ url('/admin/photos/update') }}/{{ $data -> id }}" method="post" enctype="multipart/form-data">
                    ...
                    {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <img width="200px" height="200px" src="{{ url('/uploads/hm/photos') }}/{{ $data -> photo }}"/>
                        </div>
                       <div class="form-group">
                            <label for="exampleInputFile">&nbsp;&nbsp;&nbsp;详情图像</label>

                        <input  name="photo"  size="28" accept="image/*" type="file" onchange="previewImage(this)">
