            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    @endif
                        ...
                        <form action="{{ url('/admin/FAQ/index') }}" method="get">
                        <div class="row">
                            <div class="col-md-2">
                    ...
                    <div class="box-body">
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td class="nickname">{{ $v -> question }}</td>
                                <td>{!! $v -> answer !!}</td>
                                <td><a href="{{ url('/admin/FAQ/edit/') }}/{{ $v -> id}}"><button class="btn btn-default">编辑</button></a> <br/>
                                <a href="{{ url('/admin/FAQ/delete/') }}/{{ $v -> id}}"><button class="btn btn-default">删除</button></a>
                            </tr>
                            @endforeach
                            </tbody>
                        </table>
