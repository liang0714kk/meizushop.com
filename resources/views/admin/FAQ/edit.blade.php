    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" action="{{ url('/admin/FAQ/update') }}/{{ $data -> id }}" method="post" enctype="multipart/form-data">
                    ...
                    {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <input name="question" value="{{ $data -> question }}" type="text" class="form-control" id="exampleInputName"
                                   placeholder="请输入问题">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">&nbsp;&nbsp;&nbsp;回答</label>
                         <!-- 加载编辑器的容器 -->
                        <script style="width:100%" id="container" name="answer" type="text/plain">
                        {!! $data -> answer !!}
                        </script>
                        <!-- 配置文件 -->
