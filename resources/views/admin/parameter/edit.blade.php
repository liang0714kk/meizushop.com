    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" action="{{ url('/admin/parameter/update') }}/{{ $data -> id }}" method="post" enctype="multipart/form-data">
                    ...
                    {{ csrf_field() }}
                        ...
                        <div class="form-group">
                         ...
                         <!-- 加载编辑器的容器 -->
                        <script style="width:100%" id="container" name="parameter" type="text/plain">
                        {!! $data -> parameter !!}
                        </script>
                        <!-- 配置文件 -->
