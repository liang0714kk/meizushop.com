            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">查看反馈建议信息</h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                    ...
                    @endif
                        ...
                        <form action="{{ url('/home/feedback/index') }}" method="get">
                        <div class="row">
                            <div class="col-md-2">
                    ...
                    <div class="box-body">
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td>{{ $v -> problem }}</td>
                                <td>{!! $v -> suggest !!}</td>
                                <td><a href="{{ url('/home/feedback/delete') }}/{{ $v -> id}}"><button class="btn btn-default">删除</button></a></td>
                            </tr>
                            @endforeach
                            </tbody>
                        </table>
