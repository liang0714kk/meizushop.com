...
@endif
                ...
                <b>验&nbsp;证&nbsp;码 : </b> &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="captcha" style="border:1px solid #ccc; width:250px;height:40px;" placeholder="请输入验证码">
                    <br><br>
                <a onclick="javascript:re_captcha()"><img src="{{ URL('/home/user/captcha/1') }}"  alt="验证码" title="刷新图片" width="120" height="45" id="c2c98f0de5a04167a9e427d883690ff6"  style="float:right;margin-right:10px;">
                </a><br><br><br>
