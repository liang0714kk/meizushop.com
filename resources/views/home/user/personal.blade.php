...
<head>
    ...
    <link href="css/vcodelogin.css" type="text/css" rel="Stylesheet"/>
    <!--阿里pt.js-->
...
<div class=ucSimpleHeader id="header">
    ...
    <div id="trigger">
        ...
        <img src="picture/flyme.png" alt="Flyme" class="logo hide" id="logo"/>
        <form id="mainForm" enctype="application/x-www-form-urlencoded" novalidate="novalidate">
            <div class="number">
                <a class="linkAGray" id="toAccountLogin" href="javascript:void(0);">普通登录</a>
    ...
    <div class='footerInner'>
        <div class='footer-layer1'>
            <div class='footer-innerLink'>
                ...
                <img class="foot-line" src="picture/space.gif">
...
(function() {
    ...
    <script charset="utf-8" type="text/javascript" src="js/jquery-1.7.1.min.js"></script>
    ...
    <script src="js/cycode.js"></script>
    <script type="text/javascript" src="js/vcodelogin.js" charset="utf-8"></script>
    <!--接入风控sh.min.js-->
    <script type="text/javascript" src="js/sh.min.js" charset="utf-8"></script>
    </body>
</html>
