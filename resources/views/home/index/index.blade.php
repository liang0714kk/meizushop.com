                        ...
                        <a class="category-nav-link" data-mtype="store_index_cdh_2"
                           ...
                           href="http://lists.meizu.com/page/list?categoryid=76&rc=cb&click=store_index_cdh_2" 
                            ...
                            @foreach($details_data_1 as $k1 => $v1)
                                @if($v1 -> pname == $g -> name)
                                            <li class="nav-children-item">
                                                <a href="{{ url('/home/gdetail/') }}/{{ $v1 -> id }}/{{ $v1 -> name }}" target="_blank"
                                                   data-mtype="store_index_cdh_2_1"
                                                   data-mdesc="侧边导航中第2个分类第1个产品">
                                                    <img src="/uploads/goods/{{ $v1 -> photo }}"
                                                         data-src="/uploads/goods/{{ $v1 -> photo }}" width="50"
                            ...
                            @endforeach
                                        ...
                                        <ul class="nav-children-left">
                            @foreach($details_data_2 as $k2 => $v2)
                                @if($v2 -> pname == $g -> name)
                                            <li class="nav-children-item">
                                                <a href="{{ url('/home/gdetail/') }}/{{ $v2 -> id }}/{{ $v2 -> name }}" target="_blank"
                                                   data-mtype="store_index_cdh_2_1"
                                                   data-mdesc="侧边导航中第2个分类第1个产品">
                                                    <img src="/uploads/goods/{{ $v2 -> photo }}"
                                                         data-src="/uploads/goods/{{ $v2 -> photo }}" width="50"
                                                         height="50" alt="{{ $v2 -> name }}"/>
                                                    <span>{{ $v2 -> name }}</span>
                                                </a>
                                            </li>
                                @endif
                            @endforeach
                                    ...
                                    <div class="category-item-ad">
                                        <a href="{{ url('/home/gdetail/') }}/{{ $v2 -> id }}" target="_blank"
...
<div class="site-gotop">
 <a class="gotop-suggest" title="建议反馈" href="{{ url('./home/feedback/index') }}" target="_blank"></a>
                                ...
                                <div class="rmd-box rmd-box-ad rmd-box-ad-1">
                                    <a href="http://detail.meizu.com/item/meizu_pro6.html?click=store_index_kw_1_1" target="_blank"
                                       ...
                                       data-mdesc="第1个楼层第1个坑">
                                        <img class="home-img-lazy" data-original="/uploads/first/{{ $g -> photo }}"
                                             src="/uploads/first/{{ $g -> photo }}"
                                             alt="PRO 6"/>
                                    </a>
                                    ...
                                    <div class="rmd-box rmd-box-product">
                                        <a href="{{ url('/home/gdetail/') }}/{{ $v -> id }}/{{ $v -> name }}" target="_blank"
                                           ...
                                           data-mdesc="第1个楼层第2个坑">
                                            <div class="rmd-product-detail">
                                                <img class="home-img-lazy" data-original="/uploads/goods/{{ $v -> photo}}"
                                                     alt="{{ $v -> name }}"
