            ...
            <ul class="home-category-nav">
                    ...
                    <li class="home-category-nav-item ">
                        <a class="category-nav-link" data-mtype="store_index_cdh_2"
                           ...
                           href="{{ url('/home/index/list') }}/{{ ($g -> id)}}" width="30px"
                            <span>{{ $g -> name }}</span>
                            ...
                            @foreach($details_data as $k1 => $v1)
                                @if($v1 -> pname == $g -> name)
                                            <li class="nav-children-item">
                                                <a href="{{ url('/home/gdetail/') }}/{{ $v1 -> pid }}/{{ $v1 -> name }}" target="_blank"
...
<div class="home-mzad">
  <div class="home-box home-service">
      <div class="service-module-2">
        <a data-mtype="store_index_gd_1" data-mdesc="固定资源位中第1个">
      ...
      <div class="service-module-2">
        <a data-mtype="store_index_gd_2" data-mdesc="固定资源位中第2个">
          <span class="home-service-icon service-icon-mentry">
      ...
      <div class="service-module-2">
        <a  data-mtype="store_index_gd_3" data-mdesc="固定资源位中第3个">
          <span class="home-service-icon service-icon-mentry">
      ...
      <div class="service-module-2">
        <a data-mtype="store_index_gd_4" data-mdesc="固定资源位中第4个">
          <span class="home-service-icon service-icon-mentry">
...
<div class="site-gotop">
 <a class="gotop-suggest" title="建议反馈" href="@if(session('master'))
        ...
        <div class="home-full-box white">
            <div class="mzcontainer">
                <div class="home-floor-ad">
                    <img width="1240px" height="120px" src="{{url('/uploads/banner')}}/{{ $g -> banner }}"/>
                        <a class="hot-point"
